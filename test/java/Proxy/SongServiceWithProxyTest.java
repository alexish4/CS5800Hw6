...
class SongServiceWithProxyTest {
    private SongServiceWithProxy proxySongService;
    ...
    void setUp() {
        ...
        proxySongService = new SongServiceWithProxy(new RealSongServiceServer(songs));
    }

    @Test
    void searchById() {
        Song song = proxySongService.searchById(2);
        assertNotNull(song);
    ...
    @Test
    void searchByTitle() {
        List<Song> songs = proxySongService.searchByTitle("Soma");
        assertNotNull(songs);
    ...
    @Test
    void searchByAlbum() {
        List<Song> songs = proxySongService.searchByAlbum("The Miseducation Of Lauryn Hill");
        assertNotNull(songs);
        assertFalse(songs.isEmpty());
