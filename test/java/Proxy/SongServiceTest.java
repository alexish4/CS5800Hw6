...
class SongServiceTest {
    ...
    void setUp() {
        ...
        proxySongService = new SongServiceWithProxy((RealSongServiceServer) realSongService);
    }
    ...
    void searchById() {
        ...
        song = proxySongService.searchById(2);
        assertNotNull(song);
    ...
    void searchByTitle() {
        ...
        songs = proxySongService.searchByTitle("Soma");
        assertNotNull(songs);
        assertFalse(songs.isEmpty());

        expected = "Soma";
        actual = songs.get(0).getTitle();
    ...
    void searchByAlbum() {
        ...
        songs = proxySongService.searchByAlbum("The Miseducation Of Lauryn Hill");
        assertNotNull(songs);
        assertFalse(songs.isEmpty());
